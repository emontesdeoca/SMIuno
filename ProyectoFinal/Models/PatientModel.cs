...
namespace ProyectoFinal.Models
{
    ...
    public class PatientModelDBContext : DbContext
    {
        ...
        public DbSet<ModeloCoordenadasUno> ModeloCoordenadaUno { get; set; }
        public DbSet<ModeloCoordenadasDos> ModeloCoordenadaDos { get; set; }
        public DbSet<ModeloCoordenadasTres> ModeloCoordenadaTres { get; set; }
        public DbSet<Fecha> Fecha { get; set; }
        public DbSet<Image> UploadImagen { get; set; }
    }
}